...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    @if(Auth::user()->roles==1)
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseCompliance" aria-expanded="true" aria-controls="collapseCompliance">
          <i class="fas fa-fw fa-cog"></i>
          <span>Compliance</span>
        </a>
        <div id="collapseCompliance" class="collapse {{ Request::routeIs('compliancepackage','complianceitemgroup','complianceitem') ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Compliance:</h6>
    ...
    @endif
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUserCompliance" aria-expanded="true" aria-controls="collapseUserCompliance">
          <i class="fas fa-fw fa-cog"></i>
          <span>Compliance</span>
        </a>
